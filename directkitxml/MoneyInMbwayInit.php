...
class MoneyInMbwayInit
{
     ...
     * @access public
     */
    public function __construct($wkToken, $wallet, $amountTot, $amountCom, $comment, $returnUrl, $autoCommission, $wlLogin, $wlPass, $language, $version, $walletIp, $walletUa, $phone)
    {
